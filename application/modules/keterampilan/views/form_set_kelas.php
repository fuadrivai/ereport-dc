    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="content">
                ...
                <form method="post" id="<?php echo $nama_form; ?>" name="<?php echo $nama_form; ?>" action="<?php echo base_url().$url; ?>/simpan_guru_keterampilan">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select name="keterampilan" id="keterampilan" class="form-control" required="true">
                            <option value=""></option>
                            <?php 
                            if (!empty($r_mapel)) {
