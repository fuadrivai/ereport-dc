...
<table class="table">
    ...
    <tr>
        <td style="width:90px;padding: 10px 5px;">Nilai Agama dan Budi Pekerti</td>
...
<table class="table">
    ...
    <tr>
        <td style="width:90px;padding: 10px 5px;">Jati Diri</td>
...
<table class="table">
    ...
    <tr>
        <td style="width:90px;padding: 10px 5px;">Literasi dan STEAM</td>
