...
class Data_mapel extends CI_Controller {
    ...
    public function index() {
    	$this->d['p'] = "list";
        $this->d['p_kelompok'] = array("A"=>"Kelompok A","B"=>"Kelompok B","MULOK"=>"Muatan Lokal","PUS"=>"Program Unggulan Sekolah","AOC"=>"Areas of Coverage");
        $this->d['p_tambahansub'] = array("NO"=>"All");
