<page backtop="20mm" backbottom="17mm" backleft="25mm" backimg="https://report.mhis.link/images/hanya_logo_op.png" backimgw="50%">
	<page_header><br>
	<?php if ($det_siswa['tingkat'] == 1 || $det_siswa['tingkat'] == 4){ ?>
	...
	<table>
		...
		<tr>
			...
			<td style="font-weight: bold;">
				...
				A
				<?php }else if ($det_siswa['tingkat'] == 3 || $det_siswa['tingkat'] == 4){ ?>
				B
				<?php }else if ($det_siswa['tingkat'] == 5 || $det_siswa['tingkat'] == 6){ ?>
				C
				<?php }else if ($det_siswa['tingkat'] == 7 || $det_siswa['tingkat'] == 8){ ?>
				D
				<?php }else if ($det_siswa['tingkat'] == 9 || $det_siswa['tingkat'] == 10){ ?>
				E
				<?php }else if ($det_siswa['tingkat'] == 11 || $det_siswa['tingkat'] == 12){ ?>
				F
				<?php } ?>
			</td>
		</tr>
