...
class Cetak_raport extends CI_Controller
{
    ...
    public function cetak($id_siswa, $tasm)
    {
        ...
        $siswa = $this->db->query("SELECT 
                                    ...
                                    FROM m_siswa a
                                    LEFT JOIN t_kelas_siswa_reguler b ON a.id = b.id_siswa
        ...
        foreach ($array2 as $k => $v) {
            ...
            if ($lang_mapel == 'eng') {
                ...
                $nilai_keterampilan[$k]['desk'] = empty($array2[$k]['c']) ? 'Kamu telah ' . str_replace('; ', '. ', implode("; ", $txt_desk)) : $array2[$k]['c'];
            }
        }
        ...
        if ($siswa['tingkat'] == '7' || $siswa['tingkat'] == '10' || $siswa['tingkat'] == '8' || $siswa['tingkat'] == '9' || $siswa['tingkat'] == '11'){
        $d['nilai_utama'] .= '';
        }else{
            ...
            if ($siswa['tingkat'] == '7' || $siswa['tingkat'] == '10' || $siswa['tingkat'] == '8' || $siswa['tingkat'] == '9' || $siswa['tingkat'] == '11'){
                $d['nilai_utama'] .= '
                                    <tr>
                                        ...
                                        <td colspan="2" style="width:330px; padding: 20px 10px;">' . wordwrap($npd, 500, "<br />\n") . '</td>
        ...
        $d['catatan'] = $q_catatan;
        if ($siswa['tingkat'] == '7' || $siswa['tingkat'] == '10' || $siswa['tingkat'] == '8' || $siswa['tingkat'] == '9' || $siswa['tingkat'] == '11'){
            $this->load->view('cetak_ikm_reguler', $d);
        }else{
            $this->load->view('cetak_rapot_reguler', $d);
        }
    ...
    public function cetak_sd($id_siswa, $tasm)
    {
        ...
        foreach ($q_mapel as $i => $m) {
            ...
            $nkd = empty($nilai_keterampilan[$idx]['desk']) ? "-" : $nilai_keterampilan[$idx]['desk'];
             ...
             if ($siswa['tingkat'] == '1' || $siswa['tingkat'] == '2' || $siswa['tingkat'] == '3' || $siswa['tingkat'] == '4' || $siswa['tingkat'] == '6' || $siswa['tingkat'] == '5' || $siswa['tingkat'] == '7' || $siswa['tingkat'] == '8' || $siswa['tingkat'] == '9'){
                $d['nilai_utama'] .= '
                                    <tr>
                                        <td class="ctr">' . $no++ . '</td>
                                        <td style="width:170px;">' . $m['nama'] . '</td>
        ...
        foreach ($q_mapel as $i => $m) {
            ...
            $d['nilai_utama'] .= '
                                    ...
                                    <td valign="middle">' . $nka . '</td>
                                    <td valign="middle">' . $nkp . '</td>
                                    <td style="width:130px;font-size:12px; padding: 20px 10px;">' . wordwrap($nkd, 30, "<br />\n") . '</td>
    ...
    public function index()
    {
        ...
        $wali_reguler = $this->session->userdata($this->sespre . "walikelas_reguler");
