        ...
        <div class="card">
            ...
            <div class="content">
                <ul class="list-group">
                    ...
                    <?php }else if ($mk['kelompok'] == 'AOC'){
                    ?>
                    <li class="list-group-item"><a href="<?php echo base_url()."n_catatan_guru/index/".$mk['id']; ?>"><i class="fa fa-chevron-right"></i> Areas of Coverage</a></li>
                    <?php }else if ($mk['tingkat'] == '1' || $mk['tingkat'] == '5' ||  $mk['tingkat'] == '3' || $mk['tingkat'] == '6' || $mk['tingkat'] == '7' || $mk['tingkat'] == '10' || $mk['tingkat'] == '2' || $mk['tingkat'] == '4' || $mk['tingkat'] == '8' || $mk['tingkat'] == '11'|| $mk['tingkat'] == '9'){
                    ?>
