<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="content">
                <p>
                    <a href="#" onclick="return edit(0);" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah Topik</a>
                </p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="semester" class="form-control" autofocus="true" id="semester" required>
                        <!--<p style="color: red; font-size: 10pt">DILARANG memakai spasi, koma, strip. Contoh : K01</p>-->
                    </div>
                </div>
            </div>
        ...
        if (id == 0 && kelas == 0) {
            ...
            $.getJSON(base_url+"<?php echo $url; ?>/ambil_siswa/"+kelas+"/"+id+"/"+jenis, function(data) {
                ...
                if (jenis == 'c'){
                    ...
                    var i = 1;
                    $.each(data.data, function(k, v) {
                        html += '<tr><td>'+i+'</td><td>'+v.nama+'</td><td><input name="id_siswa[]" type="hidden" value="'+v.ids+'"><input name="nilai[]" type="number" min="0" max="100" class="form-control input-sm" value="'+v.nilai+'"></td></tr>';
                        i++;
                    }); 
                }
