...
<head>
    ...
    <title>E-Raport Kurikulum 2013</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-color="blue" data-image="<?php echo base_url(); ?>aset/img/">
            <!--
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?php echo base_url(); ?>" class="simple-text">
                        <i class="pe-7s-notebook"></i> MHIS E-Raport
                    </a>
                </div>
            ...
            <nav class="navbar navbar-default navbar-fixed ">
                <div class="container-fluid">
                    <div class="navbar-header ">
                        ...
                        <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-notebook"></i> MHIS
                            E-Raport</a>
                    </div>
                    <div class="collapse navbar-collapse">
                        ...
                        ?>
                            <li><a href="#">Akun Login : <?php echo $this->session->userdata($prefix."user"); ?> </a>
                            </li>
                            <li>
